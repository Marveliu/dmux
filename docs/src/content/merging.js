...
export function render() {
  return `
    ...
    <ol>
      ...
      <li>Generates a commit message using the configured inference provider</li>
    ...
    <div class="callout callout-info">
      ...
      If the primary and backup inference targets are unavailable, dmux uses a generic commit message like "dmux: auto-commit changes".
    </div>
